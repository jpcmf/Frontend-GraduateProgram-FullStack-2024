---
description: Create a new spec file for a frontend feature
---
...
Leave all acceptance criteria as unchecked `- [ ]`. Set Status to `draft`. Ask the user to review before proceeding to implementation.
