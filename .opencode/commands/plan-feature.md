---
description: Plan implementation tasks from a frontend spec file
---
...
- What file to create or modify (with full path)
- What specific change to make
- Which acceptance criterion it satisfies

Do not write any code yet. Output the plan only and ask for confirmation before proceeding.
